...
function AdminShell() {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 flex font-sans text-[#111827]">
      <aside className="w-72 bg-[#111827] text-white flex-col hidden md:flex shadow-2xl z-20 sticky top-0 h-screen">
